package com.nemosofts.library.pflockscreen.fragments;
...
import com.nemosofts.library.pflockscreen.views.PFCodeView;
...
public class PFLockScreenFragment extends Fragment {
    ...
    private static final String INSTANCE_STATE_CONFIG
            = "com.nemosofts.library.pflockscreen.instance_state_config";
